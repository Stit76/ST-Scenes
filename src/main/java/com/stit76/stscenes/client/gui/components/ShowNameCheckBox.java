...
public class ShowNameCheckBox extends AbstractButton {
    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/gui/checkbox.png");
    private static final int TEXT_COLOR = 14737632;
    private boolean selected;
    private final boolean showLabel;
    private AbstractSTNPC npc;
    AlwaysShowNameCheckBox showAlwaysName;

    public ShowNameCheckBox(AbstractSTNPC npc,AlwaysShowNameCheckBox showAlwaysName,int p_93833_, int p_93834_, int p_93835_, int p_93836_, Component p_93837_, boolean p_93838_, boolean p_93839_) {
        super(p_93833_, p_93834_, p_93835_, p_93836_, p_93837_);
        this.npc = npc;
        this.selected = p_93838_;
        this.showLabel = p_93839_;
        this.showAlwaysName = showAlwaysName;
    }
    ...
    public void onPress() {
        ...
        if(npc != null){
            if(npc instanceof AbstractSTNPC){
                SimpleNetworkWrapper.sendToServer(new ChangeNameVisibleC2SPacket(npc.getUUID(),this.selected()));
            }
        }
    }
    ...
    public void renderWidget(PoseStack p_93843_, int p_93844_, int p_93845_, float p_93846_) {
        ...
        if(this.selected){
            ...
            this.showAlwaysName.visible = false;
        }
    }
}
