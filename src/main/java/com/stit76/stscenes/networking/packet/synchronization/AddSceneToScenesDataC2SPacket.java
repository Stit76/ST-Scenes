...
public class AddSceneToScenesDataC2SPacket {
    private Scene sceneAdded;
    private List<Scene> sceneList;
    public AddSceneToScenesDataC2SPacket(Scene sceneAdded,List<Scene> sceneList){
        this.sceneAdded = sceneAdded;
        this.sceneList = sceneList;
    }

    public AddSceneToScenesDataC2SPacket(FriendlyByteBuf buf){
    ...
    public boolean handler(Supplier<NetworkEvent.Context> supplier){
        ...
        context.enqueueWork(() -> {
            ...
            try {
                ...
                scenesData.getScenesList().add(this.sceneAdded);
                scenesData.setDirty();
