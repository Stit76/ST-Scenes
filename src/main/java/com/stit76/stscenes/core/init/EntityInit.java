...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<STNpc>> ST_NPC = ENTITES.register("st_npc",
            () -> EntityType.Builder.of(STNpc::new, MobCategory.CREATURE).sized(0.6f,1.8f)
